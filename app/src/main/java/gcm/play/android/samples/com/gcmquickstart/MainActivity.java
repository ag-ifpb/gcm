...
//            startActivity(login);
        ...
        if (checkPlayServices()) {
            //get submitted user number
            Intent data = getIntent();
            boolean regSent = msharedPreferences.getBoolean(QuickstartPreferences.SENT_TOKEN_TO_SERVER,false);

            if (!regSent) {
                // Start IntentService to register this application with GCM.
                Intent intentS = new Intent(getApplicationContext(), RegistrationIntentService.class);
                intentS.putExtra("userNumber",data.getStringExtra("userNumber"));
