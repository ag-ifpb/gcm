...
/**
 * Created by dk on 6/24/2015.
 */
public class Configs {

    public static final String SERVER_URL="http://104.236.45.161/andrew/gcm.php?shareRegId=true";
    public static final String SENDER_ID="1024018781629";
    public static final String API_KEY="AIzaSyBEENFQEh6FfuDU7EUjyAKIFInO_NwXOdQ";
    ...
    public static final String Broadcast_Action = "messageReceived";
